...
if ( ! function_exists( 'webbloger_woocommerce_get_css' ) ) {
	add_filter( 'webbloger_filter_get_css', 'webbloger_woocommerce_get_css', 10, 2 );
	function webbloger_woocommerce_get_css( $css, $args ) {
