...
if ( ! function_exists( 'webbloger_gutenberg_get_css' ) ) {
	add_filter( 'webbloger_filter_get_css', 'webbloger_gutenberg_get_css', 10, 2 );
	function webbloger_gutenberg_get_css( $css, $args ) {
