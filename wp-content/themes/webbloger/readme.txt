...
WordPress version: required at least 4.5, tested up to 6.5.3
...
Please install and activate it before starting to use the theme Webbloger.
...
Theme documentation is available on https://doc.themerex.net/trendion/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Webbloger is Fontello.
