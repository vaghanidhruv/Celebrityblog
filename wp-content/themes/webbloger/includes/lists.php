...
if ( ! function_exists('webbloger_get_not_selected_text') ) {
	/**
	 ...
	 */
	function webbloger_get_not_selected_text( $label ) {
		return apply_filters( 'webbloger_filter_not_selected_text',
								sprintf( apply_filters( 'webbloger_filter_not_selected_mask', __( '- %s -', 'webbloger' ) ), $label )
							);
	}
}

if ( ! function_exists( 'webbloger_get_list_range' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'webbloger_get_list_styles' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'webbloger' ), $i );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'webbloger' ),
			'no'  => esc_html__( 'No', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function webbloger_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'webbloger' ),
				0         => esc_html__( 'No', 'webbloger' ),
			)
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'webbloger_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'webbloger' ),
			'off' => esc_html__( 'Off', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'webbloger' ),
			'hide' => esc_html__( 'Hide', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'webbloger' ),
			'hidden'  => esc_html__( 'Hidden', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_directions' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'webbloger' ),
			'vertical'   => esc_html__( 'Vertical', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'webbloger' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'webbloger' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'webbloger' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'webbloger' ),
...
if ( ! function_exists( 'webbloger_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'webbloger' ),
				'icon'    => esc_html__( 'Icon', 'webbloger' ),
				'icons'   => esc_html__( 'Icons', 'webbloger' ),
				'zoom'    => esc_html__( 'Zoom', 'webbloger' ),
				'fade'    => esc_html__( 'Fade', 'webbloger' ),
				'slide'   => esc_html__( 'Slide', 'webbloger' ),
				'pull'    => esc_html__( 'Pull', 'webbloger' ),
				'border'  => esc_html__( 'Border', 'webbloger' ),
				'excerpt' => esc_html__( 'Excerpt', 'webbloger' ),
				'info'    => esc_html__( 'Info', 'webbloger' ),
			)
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'webbloger_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'webbloger' ),
				'fullpost' => esc_html__( 'Full post', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'webbloger' ),
...
if ( ! function_exists( 'webbloger_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = webbloger_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			webbloger_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = webbloger_array_merge( array( 'hide' => webbloger_get_not_selected_text( esc_html__( 'Select widgets', 'webbloger' ) ) ), $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'webbloger' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'webbloger' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'webbloger' ),
...
if ( ! function_exists( 'webbloger_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'webbloger' ),
				'below' => esc_html__( 'Below the content', 'webbloger' ),
				'float' => esc_html__( 'Floating bar', 'webbloger' ),
			)
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'webbloger_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'webbloger_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'webbloger_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'webbloger_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'webbloger' ),
			'over'    => esc_html__( 'Over', 'webbloger' ),
			'under'   => esc_html__( 'Under', 'webbloger' ),
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'webbloger_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'webbloger' ),
		...
		if ( apply_filters( 'webbloger_filter_allow_fullscreen', $force_fullscreen || webbloger_get_theme_setting( 'allow_fullscreen' ) || webbloger_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'webbloger' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'webbloger' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'webbloger_filter_list_body_styles', $list );
		return $prepend_inherit
					? webbloger_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'webbloger_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
...
if ( ! function_exists( 'webbloger_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'webbloger' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'webbloger' ),
...
if ( ! function_exists( 'webbloger_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'webbloger' ),
				'date'       => esc_html__( 'Published date', 'webbloger' ),
				'modified'   => esc_html__( 'Modified date', 'webbloger' ),
				'views'      => esc_html__( 'Views', 'webbloger' ),
				'likes'      => esc_html__( 'Likes', 'webbloger' ),
				'comments'   => esc_html__( 'Comments', 'webbloger' ),
				'share'      => esc_html__( 'Share links', 'webbloger' ),
				'categories' => esc_html__( 'Categories', 'webbloger' ),
				'edit'       => esc_html__( 'Edit link', 'webbloger' ),
			)
		);
...
if ( ! function_exists( 'webbloger_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'webbloger_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'webbloger' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'webbloger' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'webbloger_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? webbloger_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'webbloger_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function webbloger_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'webbloger_filter_list_single_styles', webbloger_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? webbloger_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'webbloger_get_list_categories' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_categories( $prepend_inherit = false ) {
		$list = webbloger_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'webbloger_filter_term_name', $cat->name, $cat );
				}
			}
			webbloger_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_terms' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = webbloger_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'webbloger_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			webbloger_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_posts_types( $prepend_inherit = false ) {
		$list = webbloger_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'webbloger_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'webbloger' ),
				)
			);
			webbloger_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_posts' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = webbloger_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? webbloger_get_not_selected_text( esc_html__( 'Not selected', 'webbloger' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			webbloger_storage_set( $hash, $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'webbloger_get_list_users' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = webbloger_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = webbloger_get_not_selected_text( esc_html__( 'Not selected', 'webbloger' ) );
			$users        = get_users(
				array(
			...
			webbloger_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_menus' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_menus( $prepend_inherit = false ) {
		$list = webbloger_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'webbloger' );
			...
			webbloger_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_icons' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'webbloger_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = webbloger_array_from_list( webbloger_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = webbloger_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = webbloger_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'webbloger_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'webbloger_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function webbloger_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : webbloger_parse_icons_classes( webbloger_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : webbloger_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'webbloger_get_list_images' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'webbloger_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function webbloger_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'webbloger_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'webbloger' ),
				'link2'   => esc_html__( 'Accent 2', 'webbloger' ),
				'link3'   => esc_html__( 'Accent 3', 'webbloger' ),
				'dark'    => esc_html__( 'Dark', 'webbloger' ),
			)
		);
		return $prepend_inherit ? webbloger_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'webbloger' ) ), $list ) : $list;
	}
